...
import job.apply.reference.backend.config.Constants;
import job.apply.reference.backend.domain.Authority;
import job.apply.reference.backend.domain.User;
import job.apply.reference.backend.repository.AuthorityRepository;
import job.apply.reference.backend.repository.UserRepository;
import job.apply.reference.backend.security.AuthoritiesConstants;
import job.apply.reference.backend.service.MailService;
import job.apply.reference.backend.service.UserService;
import job.apply.reference.backend.service.dto.PasswordChangeDTO;
import job.apply.reference.backend.service.dto.UserDTO;
import job.apply.reference.backend.web.rest.errors.ExceptionTranslator;
import job.apply.reference.backend.web.rest.vm.KeyAndPasswordVM;
import job.apply.reference.backend.web.rest.vm.ManagedUserVM;
