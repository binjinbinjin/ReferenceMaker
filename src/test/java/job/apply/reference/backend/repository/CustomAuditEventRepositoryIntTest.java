...
import job.apply.reference.backend.config.audit.AuditEventConverter;
import job.apply.reference.backend.domain.PersistentAuditEvent;
...
import static job.apply.reference.backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
