...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(job.apply.reference.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(job.apply.reference.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
