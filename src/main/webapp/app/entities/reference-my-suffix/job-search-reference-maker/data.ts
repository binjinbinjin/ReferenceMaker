export const coverIntro = (jobTitle: string, companyName: string): string => {
    return `<p>Jin Bin Liu <br>Markham, Ontario <br>(416) 262-8596<br>jinbinmail@gmail.com</p>
    <p>Dear HR Manager,</p>
...
export const coverEnding = () => `<p>I have outstanding time management skills along with the ability to work on more than one project at a time while staying focused and handling the top priorities first. I have attached a copy of my resume detailing my skills and experience.</p>
    ...
    <br>
    <p>Best Regards, <br>Jin Bin Liu <br>(416) 262-8596 <br>jinbinmail@gmail.com</p>
    `;
...
export const coverBody = `
        <p>${defaultCoverBackground}</p>
        <p>
...
export const coverTDDBody = `
        <p>For a quick review of my background, I have earned my bachelor's degree in computer science with hand on working experience as a freelance Backend Java Developer. To prepares for my career as a developer, I have self-study various frontend and backend technologies and put some of those technologies including Angular 6, Java, Spring Boot and MySQL to form a full-stack responsive single page application using the TDD process. Moreover, I am always in passionate about sharing my thoughts with team members and keeps conversion open. I love to take ownership of my works and enjoy finding the solution to the challenges.</p>
        <p>
          Here are some highlights of qualification:
          <br>- &nbsp Strong knowledge about Object Oriented Programming.
          <br>- &nbsp Work and University level study experience with Java, and Relational Database (MySQL).
